...
class CapabilityProposalModel(Base):
    ...
    implementation_spec: Mapped[dict | None] = mapped_column(JSON, nullable=True, default=dict)
...
class CapabilityImplementationPlanModel(Base):
    ...
    compiled_plan: Mapped[dict | None] = mapped_column(JSON, nullable=True, default=dict)
    review_notes: Mapped[str] = mapped_column(Text, nullable=False, default="")
    created_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), default=utcnow, nullable=False)
    updated_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), default=utcnow, onupdate=utcnow, nullable=False)
...
class CapabilityImplementationRunModel(Base):
    ...
    stage_results: Mapped[dict | None] = mapped_column(JSON, nullable=True, default=dict)
    post_deploy_results: Mapped[dict | None] = mapped_column(JSON, nullable=True, default=dict)
