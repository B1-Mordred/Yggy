...
from worker.handlers.tls_certificate_expiry import run_tls_certificate_expiry
...
def execute_task(
    ...
    try:
        ...
        elif task_type == "tls_certificate_expiry":
            result = run_tls_certificate_expiry(effective_config)
