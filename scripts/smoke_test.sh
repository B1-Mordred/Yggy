...
"${PYTEST_BIN}" automation-api/tests automation-worker/tests metrics-exporter/tests printer-status-exporter/tests yggdrasil/tests bragi/tests channel-bridge/tests
